...
BEGIN_SEND_TABLE_NOBASE(CTrainMayhemPlayerLocalData, DT_TMLocal)
...
BEGIN_SIMPLE_DATADESC(CTrainMayhemPlayerLocalData)
...
CTrainMayhemPlayerLocalData::CTrainMayhemPlayerLocalData()
{
	// We will probably soon remove everything but m_hLadder and possibly m_hAutoAimTarget.
	m_flSuitPower = 0.0;
	m_bZooming = false;
