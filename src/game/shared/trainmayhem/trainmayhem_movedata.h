#ifndef TRAINMAYHEM_MOVEDATA_H
#define TRAINMAYHEM_MOVEDATA_H
#ifdef _WIN32
#pragma once
#endif
...
class CTrainMayhemMoveData : public CMoveData
{
public:
	bool		m_bIsSprinting; // Will probably be unused for now.
};
