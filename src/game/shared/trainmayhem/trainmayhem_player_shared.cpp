...
const char *CTrainMayhemPlayer::GetPlayerModelSoundPrefix(void)
{
	return g_ppszPlayerSoundPrefixNames[m_iPlayerSoundType];
}

void CTrainMayhemPlayer::PrecacheFootStepSounds(void)
{
...
//-----------------------------------------------------------------------------
Vector CTrainMayhemPlayer::GetAttackSpread(CBaseCombatWeapon *pWeapon, CBaseEntity *pTarget)
{
	if (pWeapon)
...
//-----------------------------------------------------------------------------
void CTrainMayhemPlayer::PlayStepSound(Vector &vecOrigin, surfacedata_t *psurface, float fvol, bool force)
{
...
CPlayerAnimState::CPlayerAnimState(CTrainMayhemPlayer *outer)
	: m_pOuter(outer)
{
	m_flGaitYaw = 0.0f;
...
// Output : CBasePlayer
//-----------------------------------------------------------------------------
CTrainMayhemPlayer *CPlayerAnimState::GetOuter()
{
	return m_pOuter;
}
