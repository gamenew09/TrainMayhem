...
{
	static ClientModeTrainMayhemNormal g_ClientModeNormal;
...
//-----------------------------------------------------------------------------
// ClientModeTrainMayhemNormal implementation
//-----------------------------------------------------------------------------
ClientModeTrainMayhemNormal::ClientModeTrainMayhemNormal()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void ClientModeTrainMayhemNormal::Init()
{
	BaseClass::Init();
...
bool ClientModeTrainMayhemNormal::ShouldDrawCrosshair(void)
{
	//return (g_bRollingCredits == false);
	return true; // For now, we actually don't have credits. Why would we?
}
