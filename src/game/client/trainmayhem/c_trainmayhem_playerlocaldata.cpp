...
BEGIN_RECV_TABLE_NOBASE(C_TrainMayhemPlayerLocalData, DT_TMLocal)
...
BEGIN_PREDICTION_DATA_NO_BASE(C_TrainMayhemPlayerLocalData)
DEFINE_PRED_FIELD(m_hLadder, FIELD_EHANDLE, FTYPEDESC_INSENDTABLE),
END_PREDICTION_DATA()

C_TrainMayhemPlayerLocalData::C_TrainMayhemPlayerLocalData()
{
	m_flSuitPower = 0.0;
	m_bZooming = false;
